...
With supplier_parts as (
  SELECT * from demo_snowflake_sample_data.tpch_sf1.supplier
    JOIN demo_snowflake_sample_data.tpch_sf1.partsupp
        ON s_suppkey=ps_suppkey
            JOIN demo_snowflake_sample_data.tpch_sf1.part
